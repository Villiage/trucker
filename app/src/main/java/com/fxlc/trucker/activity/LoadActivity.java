...
public class LoadActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setValue() {
        ...
        trucksTx.setText("接单车辆：" + current.getAgreeTrucks() + " | " + "待装车辆：" + current.getWaiLoadTrucks());
        timeTx.setText("装货时间：" + current.getLoadTime());
    ...
    private void loadOrder() {
        ...
        map.put("loadWeight", weightTx.getText().toString());
        ...
        Call<HttpResult<CurrentOrder>> call = service.loadOrder(map, body);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.call:
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + current.getLoadPhone()));
